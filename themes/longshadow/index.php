...
<head>
    ...
    <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Fredoka%20One" async>
...
<div class="container">
    <div class="text-center long-shadow"><?php echo $view['main']['name']; ?></div>
    <h4 class="text-center"><?php echo $view['main']['slogan']; ?></h4>
    <hr>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <?php echo $view['main']['faucet_html']; ?>
            <hr>
